		...
		return this;
			...
			buildImage: function(imageData, isSync) {
				...
				var newSlide = this.$imageContainer
					.append('<span class="image-wrapper current"><a class="advance-link" rel="history" href="'+imageData.full_size+'" title="'+imageData.title+'">&nbsp;</a></span>')
				...
				newSlide.find('a')
					...
					.fancybox({
		                 ...
		                 overlayColor: '#000000',
						 onStart: function(){
						   is_running = gallery.isSlideshowRunning;
	                       if(is_running) gallery.pause();
	                     },
	                     onClosed: function(){
						   if(is_running) gallery.play();
	                     },
	                     titlePosition: 'over',
